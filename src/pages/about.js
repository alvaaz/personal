...
const About = () => (
	<>
		...
		<Main type={false}>
			...
			<div className="flex flex-wrap mb-32 w-full lg:w-3/4">
				<div className="w-full sm:w-2/5 mb-4 mr-16">
					<h1 className="text-5xl font-bold">Main skills.</h1>
					...
					<div className="pb-5 pt-4">
						<p className="text-3xl font-semibold">Interaction design</p>
						<p className="text-3xl font-semibold text-gray-500">
				...
				<div className="w-full sm:w-2/5 mb-4">
					...
					<div className="pb-5 pt-4">
						<p className="text-3xl font-semibold">Never not learning</p>
						<p className="text-3xl font-semibold text-gray-500">
			...
			<div className="mb-32">
				<h1 className="text-5xl font-bold leading-tight w-full lg:w-2/5 mb-10">
					Features, interviews, mentions & recognition.
				</h1>
				<div className="pb-5 pt-4">
					<p className="text-3xl font-semibold">Features</p>
					<ul>
						<li className="text-3xl font-semibold text-gray-500">
				...
				<div className="pb-5 pt-4">
					<p className="text-3xl font-semibold">Study</p>
					<ul>
						<li className="text-3xl font-semibold text-gray-500">
